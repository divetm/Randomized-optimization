...
fitness = mlrose.Knapsack(weights=[10, 5, 2, 8, 15], values=[1, 2, 3, 4, 5], max_weight_pct=0.35)
...
rhc = mlrose.RHCRunner(problem=problem,
                       ...
                       output_directory="/Users/matthieudivet/Desktop/GaTech/Classes/ML/Assignments/Randomized_optimization/knapsack_problem/RHC",
                       seed=None,
...
sa = mlrose.SARunner(problem=problem,
                     ...
                     output_directory="/Users/matthieudivet/Desktop/GaTech/Classes/ML/Assignments/Randomized_optimization/sknapsack_problem/SA",
                     seed=None,
                     iteration_list=2 ** np.arange(12),
                     max_attempts=1000,
...
ga = mlrose.GARunner(problem=problem,
                     ...
                     output_directory="/Users/matthieudivet/Desktop/GaTech/Classes/ML/Assignments/Randomized_optimization/knapsack_problem/GA",
                     seed=None,
                     iteration_list=2 ** np.arange(12),
                     max_attempts=1000,
...
mimic = mlrose.MIMICRunner(problem=problem,
                           ...
                           output_directory="/Users/matthieudivet/Desktop/GaTech/Classes/ML/Assignments/Randomized_optimization/knapsack_problem/MIMIC",
                           seed=None,
                           iteration_list=2 ** np.arange(12),
